...
public class MainApp {
    public static int verifyCifra_de_Control(String cnp)
    {
        ...
        if (cnp.length() == 13)
        {
            ...
            if (numere == 13)
                if(cnp.charAt(0) == '1' || cnp.charAt(0) == '2' || cnp.charAt(0) == '5' || cnp.charAt(0) == '6')
                    if (Character.getNumericValue(cnp.charAt(12)) == verifyCifra_de_Control(cnp))
                        return 1;
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Cate persoane sunt: ");
        n = sc.nextInt();
        sc.nextLine();
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            nume = sc.nextLine();
            System.out.print("CNP: ");
            while (verifyCNP(cnp = sc.nextLine()) == 0);
            pers.add(new Persoana(nume, cnp));
        }
        //afisare nume, cnp, varsta
        for (Persoana p: pers)
